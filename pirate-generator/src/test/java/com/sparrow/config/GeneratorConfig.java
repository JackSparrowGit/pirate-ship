...
public class GeneratorConfig {
    ...
    private void batchOutput ( String entityName, VelocityContext context ) {
        try {
            ...
            String entityFile = String.format(
                    ( pathInfo.get( ConstVal.ENTITY_PATH )  + File.separator + tableInfo
                            .getEntityName() + ConstVal.JAVA_SUFFIX ),
                    entityName
            );
    ...
    public GeneratorConfig setDataSource (DataSourceConfig dataSource ) {
    ...
    public GeneratorConfig setStrategy (StrategyConfig strategy ) {
    ...
    public GeneratorConfig setPackageInfo (PackageConfig packageInfo ) {
    ...
    public GeneratorConfig setTemplate (TemplateConfig template ) {
    ...
    public GeneratorConfig setConfig (ConfigBuilder config ) {
        this.config = config;
        return this;
    }
    ...
    public GeneratorConfig setGlobalConfig (GlobalConfig globalConfig ) {
    ...
    public GeneratorConfig setCfg (InjectionConfig injectionConfig ) {
